...
- **Motion**, all of it disabled under `prefers-reduced-motion`: the entrance counter (once per session, `sessionStorage`), the marquee (paused on hover), the rotating badge, hover response, and the hero fluid.
